...
# Settings used with the mail server configured by me
...
SECRET_KEY = 'jw@ny((p+wsltx#4-i0nizk3bnf4obet%j*)f!8hnboc+l49_a'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/kheops/Projects/djcode/mysite/mysite/templates',
)
